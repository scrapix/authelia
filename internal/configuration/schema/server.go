...
type ServerEndpointsAuthzAuthnStrategy struct {
	...
	Schemes []string `koanf:"schemes" json:"schemes" jsonschema:"enum=basic,enum=bearer,default=basic,title=Schemes" jsonschema_description:"The name of the authorization schemes to allow with the header strategies"`
}
